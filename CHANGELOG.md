...
- **Natel (≤ 760 px)** : carte de connexion compacte et vitrée (`backdrop-filter`) pour laisser voir le fond autour et à travers le formulaire (272 px max, transparence renforcée).
